...
<div class="bg-white rounded-lg shadow-md p-4 mb-6">
    <form method="GET" action="<?php echo site_url('user'); ?>" class="flex gap-2">
        <div class="flex-grow">
            <input type="text" name="search" placeholder="Cari berdasarkan username, email, atau nama lengkap..." 
        ...
        <?php if (isset($search) && $search): ?>
            <a href="<?php echo site_url('user'); ?>" class="bg-gray-400 hover:bg-gray-500 text-white font-semibold py-2 px-6 rounded-lg transition">
